...
- (void)layoutSubviews {
    ...
    self.titleLabel.frame    = (CGRect){85, 0, 110, self.frame.size.height};
...
//    self.highlightedImage= [[UIImage imageNamed:self.imageName] imageWithTintColor:[UIColor blueColor]];
